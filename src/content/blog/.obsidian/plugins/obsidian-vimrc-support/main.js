...
class VimrcPlugin extends obsidian.Plugin {
  ...
  async updateSelectionEvent() {
    ...
    if (
      this.getCursorActivityHandlers(cm).some(e => e.name === "updateSelection")
    )
      return;
  ...
  prepareVimModeDisplay() {
    if (this.settings.displayVimMode) {
      ...
      this.vimStatusBar.setText(
        this.settings.vimStatusPromptMap["normal" /* vimStatus.normal */]
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addText(text => {
        ...
        text.setValue(
          this.plugin.settings.vimrcFileName || DEFAULT_SETTINGS.vimrcFileName
        );
        text.onChange(value => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(toggle => {
        toggle.setValue(
          this.plugin.settings.displayChord || DEFAULT_SETTINGS.displayChord
        );
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(toggle => {
        toggle.setValue(
          this.plugin.settings.displayVimMode || DEFAULT_SETTINGS.displayVimMode
        );
        toggle.onChange(value => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(toggle => {
        ...
        toggle.onChange(async value => {
          ...
          if (
            value &&
            Object.keys(this.plugin.settings.capturedKeyboardMap).length === 0
          )
            this.plugin.settings.capturedKeyboardMap =
              await this.plugin.captureKeyboardLayout();
          this.plugin.saveSettings();
